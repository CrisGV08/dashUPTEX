...
SECRET_KEY = 'django-insecure-r_2l5jl&^c_hs$c2=k^3b=w35*cnuxavj1_rlyi#fggm_0o%@u'
...
MIDDLEWARE = [
    ...
    'api.middleware.LoginRequiredMiddleware',  # 👈 Aquí debe ir
...
#aqui se define donde se van a copiar
